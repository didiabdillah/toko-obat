...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/landing/'); ?>fonts/icomoon/style.css">
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/landing/'); ?>css/jquery-ui.css">
...
<body>
    ...
    <div class="site-wrap">
                    ...
                    <div class="main-nav d-none d-lg-block">
                        <nav class="site-navigation text-right text-md-center" role="navigation">
                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                ...
                                <li><a href="shop.html">Etalase</a></li>
        ...
        <div class="site-blocks-cover" <?php echo 'style="background-image: url(' . base_url() . 'assets/img/hero_1.jpg' . ');"'; ?>>
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
                        <div class="site-block-cover-content text-center">
                            <!-- <h2 class="sub-title">Effective Medicine, New Medicine Everyday</h2> -->
                            <h1>Selamat Datang Exodus Drugstore</h1>
                            <p>
                                <a href="shop.html" class="btn btn-primary px-5 py-3">Belanja Sekarang</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <div class="site-section bg-secondary bg-image" style="background-image: url('images/bg_2.jpg');">
      ...
      <div class="container">
        ...
        <script src="<?php echo base_url('assets/landing/'); ?>js/jquery-3.3.1.min.js"></script>
        <script src="<?php echo base_url('assets/landing/'); ?>js/jquery-ui.js"></script>
