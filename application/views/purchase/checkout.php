        ...
        <div class="row">
          <div class="col-md-6 mb-5 mb-md-0">
            ...
            <div class="p-3 p-lg-5 border">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <label for="c_companyname" class="text-black">Nama Lengkap </label>
              ...
              <div class="form-group row mb-5">
                ...
                <div class="col-md-6">
                  <label for="c_phone" class="text-black">Nomor Telephone <span class="text-danger">*</span></label>
              ...
              <div class="form-group">
                ...
                <div class="collapse" id="ship_different_address">
                  <div class="py-2">
                    ...
                    <div class="form-group row">
                      <div class="col-md-12">
                        <label for="c_diff_companyname" class="text-black">Nama Lengkap </label>
                    ...
                    <div class="form-group row mb-5">
                      ...
                      <div class="col-md-6">
                        <label for="c_diff_phone" class="text-black">Nomor Telephone <span class="text-danger">*</span></label>
          ...
          <div class="col-md-6">
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                <h2 class="h3 mb-3 text-black">Kode Voucher</h2>
                <div class="p-3 p-lg-5 border">
    
                  <label for="c_code" class="text-black mb-3">Masukkan kode voucher</label>
                  <div class="input-group w-75">
                    <input type="text" class="form-control" id="c_code" placeholder="Kode Voucher" aria-label="Kode voucher"
                      aria-describedby="button-addon2">
                    <div class="input-group-append">
                      <button class="btn btn-primary btn-sm px-4" type="button" id="button-addon2">Pakai</button>
                    </div>
                  </div>
